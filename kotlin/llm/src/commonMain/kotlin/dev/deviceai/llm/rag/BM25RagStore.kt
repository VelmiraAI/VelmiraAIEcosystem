 ...
 */
class BM25RagStore(
    private val rawChunks: List<String>,
    ...
    private fun buildIndex(): BM25Index {
        ...
        val avgdl = if (indexed.isEmpty()) 1f
                    else indexed.sumOf { it.length }.toFloat() / indexed.size
    ...
    companion object {
        ...
        ): BM25RagStore = BM25RagStore(texts, sources)
    }
}
